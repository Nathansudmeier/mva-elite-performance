...
export default function WebsiteContact() {
  ...
  return (
    <WebsiteLayout>
      <section style={{ height: "450px", background: inst?.contact_image_url ? `url(${inst.contact_image_url}) center/cover` : "linear-gradient(160deg, #1B2A5E 0%, #0F1630 100%)", display: "flex", alignItems: "flex-end", position: "relative", backgroundPosition: "center top" }}>
