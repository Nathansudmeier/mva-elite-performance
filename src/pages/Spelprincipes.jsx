  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="glass-dark modal-scroll-content w-full xl:max-w-2xl xl:my-8 flex flex-col mt-16"
            style={{ borderRadius: "24px 24px 0 0", maxHeight: "calc(95vh - 64px)", overscrollBehavior: "contain", WebkitOverflowScrolling: "touch" }}
  ...
  return (
    <div className="min-h-screen pb-20" style={{ backgroundColor: "#1c0e04" }}>
      <img src="https://media.base44.com/images/public/69ad40ab17517be2ed782cdd/1c0b85909_Tacticsbackground.jpg" alt=""
        style={{ position: "fixed", inset: 0, width: "100%", height: "100%", objectFit: "cover", zIndex: 0, filter: "blur(3px)" }} />
