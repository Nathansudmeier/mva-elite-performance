...
import { ChevronLeft, Clock, Pencil, Trash2, Play, Trophy, RotateCcw, Ban, Check } from "lucide-react";
...
export default function PlanningWedstrijdDetail() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxWidth: "100vw", overflowX: "hidden", boxSizing: "border-box", background: "transparent", padding: "16px", paddingBottom: "150px", minHeight: "100vh" }}>
      ...
      {/* Hero card */}
      <div style={{ background: teamCardBg, opacity: item.cancelled ? 0.6 : 1, border: "2.5px solid #1a1a1a", borderRadius: 22, boxShadow: "3px 3px 0 #1a1a1a", padding: 20, position: "relative", overflow: "hidden" }}>
